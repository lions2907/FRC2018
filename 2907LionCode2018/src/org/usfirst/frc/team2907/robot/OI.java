...
import org.usfirst.frc.team2907.robot.commands.GrabClose;
import org.usfirst.frc.team2907.robot.commands.GrabOpen;
...
public class OI {
	...
	public static Button gripClose = new JoystickButton(oiJoy, 5);
	public static Button gripOpen = new JoystickButton(oiJoy, 6);
	
	public static Button shaftDown = new JoystickButton(oiJoy, 1);
	public static Button shaftUp = new JoystickButton(oiJoy, 2);
	
	public OI() {
		shiftUp.whenPressed(new ShiftUp());
		shiftDown.whenPressed(new ShiftDown());
		
		gripClose.whenPressed(new GrabClose());
		gripOpen.whenPressed(new GrabOpen());
